...
public class ModifyUserModal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        emailAddressField = new swing_assets.TextField();
        ...
        confirmButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                if(clearanceLevelSpinner.getSelectedIndex() + 1 >= 5){
                    updateDatabase(userUUID, keyUUID, firstNameField.getText().toString(), lastNameField.getText().toString(), loginKeyField.getText().toString(), !isSuspendedCheck.isSelected(), clearanceLevelSpinner.getSelectedIndex() + 1, emailAddressField.getText());
                    dispose();
                } else{
                    try {
                        updateDatabase(userUUID, keyUUID, firstNameField.getText().toString(), lastNameField.getText().toString(), !isSuspendedCheck.isSelected(), clearanceLevelSpinner.getSelectedIndex() + 1, emailAddressField.getText());
                        dispose();
        ...
        emailAddressField.setBackground(new java.awt.Color(247, 247, 247));
        emailAddressField.setText("Enter an email");
        emailAddressField.setFont(new java.awt.Font("Microsoft JhengHei UI", 0, 12)); // NOI18N
        ...
        emailAddressTitle.setFont(new java.awt.Font("Microsoft YaHei UI", 1, 14)); // NOI18N
        emailAddressTitle.setForeground(new java.awt.Color(255, 255, 255));
        emailAddressTitle.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        emailAddressTitle.setText("Email Address");
        emailAddressTitle.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                emailAddressTitleMouseEntered(evt);
            }
        });
                ...
                innerPaneBlueLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(innerPaneBlueLayout.createSequentialGroup()
                                ...
                                .addGroup(innerPaneBlueLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(innerPaneBlueLayout.createSequentialGroup()
                                                .addGroup(innerPaneBlueLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        .addComponent(emailAddressField, javax.swing.GroupLayout.PREFERRED_SIZE, 227, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                        .addGroup(innerPaneBlueLayout.createSequentialGroup()
                                                                .addGap(6, 6, 6)
        ...
        outerPaneWhiteLayout.setVerticalGroup(
                outerPaneWhiteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(outerPaneWhiteLayout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(innerPaneBlue, javax.swing.GroupLayout.PREFERRED_SIZE, 323, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void emailAddressFieldActionPerformed(ActionEvent evt) {
    }

    private void emailAddressTitleMouseEntered(MouseEvent evt) {
    }

    private void emailAvoidddressFieldActionPerformed(ActionEvent evt) {
    }

    public void setValues(User user) {
        userUUID = user.getId().toString();
        keyUUID = user.getKey().getId().toString();
        firstNameField.setText(user.getFirstName());
        lastNameField.setText(user.getLastName());
        clearanceLevelSpinner.setSelectedIndex(user.getKey().getClearanceLevel() - 1);
        if(user.getKey().getClearanceLevel() >= 5)
            loginKeyField.setText(user.getLoginKey());
        else{
            loginKeyField.setEnabled(false);
            loginKeyField.setText("");
        }
        emailAddressField.setText(user.getEmail());
        isSuspendedCheck.setSelected(!user.getKey().getIsActive());
    }
    ...
    private void updateDatabase(String userId, String keyId, String firstName, String lastName, boolean isActive, int clearanceLevel, String email) throws SQLException{
        terminal.modifyUser(userId, keyId, firstName, lastName, isActive, clearanceLevel, email);
    }

    private void updateDatabase(String userId, String keyId, String firstName, String lastName, String loginKey, boolean isActive, int clearanceLevel, String email) {
        terminal.modifyUser(userId, keyId, firstName, lastName, loginKey, isActive, clearanceLevel, email);
    }
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(ModifyUserModal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModifyUserModal().setVisible(true);
            }
        });
    }
    ...
    private swing_assets.TextField emailAddressField;
