...
public class SystemTerminal extends App{
    ...
    public User addUser(String userId, String keyId, String firstName, String lastName, boolean isActive, int clearanceLevel, String email){
        ...
        PreparedStatement upstmt = con.prepareStatement(insertStatementUsers);PreparedStatement ppstmt = con.prepareStatement(insertStatementKeyCards);) 
        {
            ...
            User newUser = new User(firstName, lastName, key, email);
            ...
            upstmt.setString(5, newUser.getEmail());
            ...
            String message = "Hey " + newUser.getFirstName() + "!\nWe wanted to personally welcome you to our incredible team! We hope to share many memorable experiences with you!\n\nIf you ever need any help, please reach out to us by email or a managing representative!\n\nWarm Regards,\nThe Team 😁";

            new Mailer().sendMail("Welcome to the Club! 👋", message, newUser.getEmail());
        }
    ...
    public User addUser(String userId, String keyId, String firstName, String lastName, String loginKey, boolean isActive, int clearanceLevel, String email){
        String url = "jdbc:mysql://localhost/files";
        String uid = "root";
        String pw = "310rootypw";
        ...
        {
            Key key = new Key(clearanceLevel, isActive);
            User newUser = new User(firstName, lastName, key, loginKey, email);
            ...
            upstmt.setString(6, newUser.getEmail());
    ...
    public void modifyUser(String userId, String keyId, String firstName, String lastName, boolean isActive, int clearanceLevel, String email) throws SQLException{
        String url = "jdbc:mysql://localhost/files";
        String uid = "root";
        String pw = "310rootypw";
        ...
        String updateStatementUser = """
            UPDATE users 
            SET firstName = ?, lastName = ?, loginKey = ?, email = ?
            WHERE uuid = ?
        """;
        ...
        PreparedStatement upstmt = con.prepareStatement(updateStatementUser); PreparedStatement kpstmt = con.prepareStatement(updateStatementKey);) 
        {
            ...
            upstmt.setString(5, userId); // UUID
            ...
            User user = findUser(findKey(UUID.fromString(keyId)));
            String message = "Hey!\nYour account details were recently modified. Please reach out managing representative for further details!\n \nWarm Regards, \nManagement Team";
            new Mailer().sendMail("Account Modifications! 👀", message, user.getEmail());
    ...
    public void modifyUser(String userId, String keyId, String firstName, String lastName, String loginKey, boolean isActive, int clearanceLevel, String email){
                String url = "jdbc:mysql://localhost/files";
        String uid = "root";
        String pw = "310rootypw";
            ...
            if(size == 1){
                ...
                while(resultSet.next()){
                    ...
                    if(key.getClearanceLevel() >= 5){
                        ...
                        return new User(idK, firstName, lastName, key, loginKey, email);
                    }

                    return new User(idK, firstName, lastName, key, email);
                }
            } else{
                // -TO-DO-
                // RAISE EXCEPTION
        ...
        ResultSet.CONCUR_UPDATABLE);) 
        {
            ...
            if(size == 1){
                ...
                while(resultSet.next()){
                    ...
                    if(key.getClearanceLevel() >= 5){
                        String loginKey = resultSet.getString("loginKey");
                        return new User(id, firstName, lastName, key, loginKey, email);
                    }
                    
                    return new User(id, firstName, lastName, key, email);
                }
            } else{
                // -TO-DO-
                // RAISE EXCEPTION
