...
import org.example.sheetsExtract;
...
public class SystemTerminalGui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        announcements_container = new javax.swing.JPanel();
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("undraw_my_password.png"))); // NOI18N
        ...
        userLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("users-alt.png"))); // NOI18N
        ...
        systemLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("code-compare.png"))); // NOI18N
        ...
        logOutLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("exit.png"))); // NOI18N
        ...
        announcementsLabel.setFont(new java.awt.Font("Microsoft YaHei UI", 0, 12)); // NOI18N
        announcementsLabel.setForeground(new java.awt.Color(40, 48, 59));
        announcementsLabel.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        announcementsLabel.setText("Announcements");
        announcementsLabel.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 2, 0, 0));
        announcementsLabel.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                try {
                    List<List<Object>> values = new sheetsExtract().fetchData();
                    if(values == null || values.isEmpty()){
                        System.out.println("No Data found.");
                    } else {
                        for (List row: values){
                            String title = row.get(0).toString();
                            String message = row.get(2).toString();
                            String author = row.get(1).toString();
                            String date = row.get(3).toString();
                            announcements_container.add(new announcementPan(title, message, author, date));
                            announcements_container.revalidate();
                        }
                    }
                } catch (IOException e) {
                ...
                paneCollection.setSelectedIndex(2);
            }
        });
            ...
            .addGroup(navigationBarLayout.createSequentialGroup()
                ...
                .addGroup(navigationBarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(logOutLabel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(announcementsLabel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE)))
        );
        navigationBarLayout.setVerticalGroup(
                navigationBarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(navigationBarLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(announcementsLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(208, 208, 208)
        ...
        imageLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("undraw_dev_focus_re_6iwt@0.8x.png"))); // NOI18N
        ...
        announcementPane.setBackground(new java.awt.Color(247, 247, 247));
        announcementPane.setForeground(new java.awt.Color(247, 248, 252));

        announcements_container.setBackground(new java.awt.Color(247, 248, 252));
        announcements_container.setForeground(new java.awt.Color(247, 248, 252));
        announcements_container.setLayout(new javax.swing.BoxLayout(announcements_container, javax.swing.BoxLayout.Y_AXIS));
        ...
        announcementPaneLayout.setHorizontalGroup(
                announcementPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(announcementPaneLayout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(announcements_container, javax.swing.GroupLayout.DEFAULT_SIZE, 759, Short.MAX_VALUE)
                                .addContainerGap())
        );
        announcementPaneLayout.setVerticalGroup(
                announcementPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(announcementPaneLayout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(announcements_container, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addContainerGap(1138, Short.MAX_VALUE))
        );

        paneCollection.addTab("tab3", announcementPane);
    ...
    private javax.swing.JPanel announcements_container;
